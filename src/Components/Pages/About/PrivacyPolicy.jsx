  ...
  return (
    <div className="mt-20 px-sectionPadding max-md:px-mobileScreenPadding py-16 bg-gray-100">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="font-headings text-2xl font-semibold text-gray-800 mb-4">How We Use Your Information</h2>
        <p className="font-texts text-lg text-gray-700 mb-4">
        ...
        <h2 className="font-headings text-2xl font-semibold text-gray-800 mb-4">Sharing Your Information</h2>
        <p className="font-texts text-lg text-gray-700 mb-4">
        ...
        <h2 className="font-headings text-2xl font-semibold text-gray-800 mb-4">Your Consent</h2>
        <p className="font-texts text-lg text-gray-700 mb-4">
