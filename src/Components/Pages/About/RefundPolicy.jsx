...
const RefundPolicy = () => {
  return (
    ...
    <div className="max-w-4xl mx-auto">
      <h1 className="font-headings text-3xl font-bold text-[#8A5D3B] mb-6">Returns & Refund Policy</h1>
      <p className="font-texts text-lg mb-4">
        ...
        <p className="font-texts text-lg text-gray-700 mb-4">
          Once we receive and inspect your returned item, we will notify you of the status of your refund. If approved, your refund will be processed, and a credit will be applied to your original method of payment within 10 days.
        </p>
        <h2 className="font-headings text-2xl font-semibold text-[#8A5D3B] mb-4">Exchanges</h2>
        <p className="font-texts text-lg text-gray-700 mb-4">
          We only replace items if they are defective or damaged. If you need to exchange an item, please contact us at nilayrathod129@gmail.com with details of the issue.
        </p>
        <p className="font-texts text-lg text-gray-700 mb-4">
          If you have any further questions about our returns and refund policy, please do not hesitate to contact us at nilayrathod129@gmail.com .
        </p>
      </div>
    </div>
  );
